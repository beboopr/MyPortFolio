      ...
      <header className="App-header">
        ...
        <main className=" bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40">
          <section className="min-h-screen">
            ...
            <div className="text-center p-10 py-10">
              ...
              <p className="text-md py-5 leading-8 text-gray-800 dark:text-gray-200 max-w-xl mx-auto md:text-xl">
                I offer my expertise in programming and design to help with any
                of your content needs. Please contact me to begin working on
                your project!
              </p>
          ...
          <section>
            <div>
              ...
              <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
                As a freelance designer and developer, I have a diverse
                experience working remotely for
                <span className="text-teal-500"> agencies </span>
                consulted for <span className="text-teal-500">startups </span>
                and collaborating with a talented team to produce digital
                products for both business and consumer use throughout my career
                journey.
              </p>
              <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
          ...
          <section className="py-10">
            <div>
              <h3 className="font-burtons text-3xl py-1 dark:text-white ">
                Portfolio
              </h3>
              <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
